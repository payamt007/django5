...
# from rss_parser.tasks import retry_failed_feeds, save_feed_items
...
#     @patch('base.tasks.retry_failed_feeds.apply_async')
#     @patch('base.tasks.feedparser.parse')
#     def test_retry_failed_second_time_exception(self, mock_parse: MagicMock,
#                                                 mock_retry_failed_feeds: MagicMock) -> None:
#         mock_parse.side_effect = Exception
#
#         retry_failed_feeds(self.feed.id)
#
